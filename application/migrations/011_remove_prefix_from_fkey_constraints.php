...
class Migration_Remove_prefix_from_fkey_constraints extends CI_Migration {
    ...
    {
        // Drop table constraints.
        $this->db->query('ALTER TABLE ' . $this->db->dbprefix('appointments') . ' DROP CONSTRAINT appointments_services');
        $this->db->query('ALTER TABLE ' . $this->db->dbprefix('appointments') . ' DROP CONSTRAINT appointments_users_customer');
        $this->db->query('ALTER TABLE ' . $this->db->dbprefix('appointments') . ' DROP CONSTRAINT appointments_users_provider');
        $this->db->query('ALTER TABLE ' . $this->db->dbprefix('secretaries_providers') . ' DROP CONSTRAINT secretaries_users_secretary');
        $this->db->query('ALTER TABLE ' . $this->db->dbprefix('secretaries_providers') . ' DROP CONSTRAINT secretaries_users_provider');
        $this->db->query('ALTER TABLE ' . $this->db->dbprefix('services_providers') . ' DROP CONSTRAINT services_providers_users_provider');
        $this->db->query('ALTER TABLE ' . $this->db->dbprefix('services_providers') . ' DROP CONSTRAINT services_providers_services');
        $this->db->query('ALTER TABLE ' . $this->db->dbprefix('services') . ' DROP CONSTRAINT services_service_categories');
        $this->db->query('ALTER TABLE ' . $this->db->dbprefix('users') . ' DROP CONSTRAINT users_roles');
        $this->db->query('ALTER TABLE ' . $this->db->dbprefix('user_settings') . ' DROP CONSTRAINT user_settings_users');
